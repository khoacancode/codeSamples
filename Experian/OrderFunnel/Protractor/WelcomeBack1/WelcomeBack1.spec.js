describe("WelcomeBack1 Test", function () {
    ...
    //check to see if sign-in process redirects to WelcomeBack1 and customer clicks yes
    it('sign in, verify ssn, go to welcomeback1, click yes', function () {
        //sign in
        ...
        ptor.sleep(2000);
        expect(ptor.getCurrentUrl()).toContain('welcomeback1');
        ...
        expect(dynamic.name.getText()).toEqual("Welcome back WIL.");
        ...
        expect(ptor.getCurrentUrl()).toContain('credit#/reorder?pkgid=E3FDZ&areaid=28');

        //check to see if No button redirects to member center
        //ptor.get('/credit#/welcomeback1');
        //ptor.sleep(2000);
